...
public class TownMenu extends Menu {
    ...
    public TownMenu(Town town, Player player) throws NotRegisteredException {
        ...
        for (Player players : Bukkit.getOnlinePlayers()) {
            try {
                allOnlineResidents.add(TownyUniverse.getInstance().getResident(players.getName()));
        ...
        if (townBlock != null && town.hasTownBlock(townBlock))
            plotMenuButton = new ButtonMenu(new PlotMenu(townBlock), plotMenuItem);
        else
    ...
    public class ToggleSettingsMenu extends Menu {
        ...
        public ToggleSettingsMenu(Town town) {
            ...
            explosionToggle = new Button() {
                ...
                @Override
                public ItemStack getItem() {
                    return ItemCreator.of(CompMaterial.TNT, Localization.TownMenu.ToggleMenu.EXPLODE, "", town.isBANG() ? Localization.TownMenu.ToggleMenu.TOGGLE_OFF : Localization.TownMenu.ToggleMenu.TOGGLE_ON).build().make();
                        ...
                        for (Player onlinePlayer : onlinePlayers) {
                            ...
                            if (onlinePlayerAsRes != null && onlinePlayerAsRes.hasTown()) {
                                if (!onlinePlayerAsRes.getTown().equals(town)) {
                                    TownBlock townBlock = TownyUniverse.getInstance().getTownBlock(WorldCoord.parseWorldCoord(onlinePlayer.getLocation()));
        ...
        protected GeneralSettingsMenu(Town town) {
            ...
            setSpawnButton = new Button() {
                ...
                public void onClickedInMenu(Player player, Menu menu, ClickType click) {
                    ...
                    try {
                        if (townBlock != null && townBlock.isHomeBlock() && townBlock.getTown().equals(town)) {
